...
class SearchProdcutsUsecase {
  ...
  SearchProdcutsUsecase({required this.productRepo});
  Future<Either<Failure, List<ProductEntity>>> call(String searchQuery) {
    return productRepo.searchProducts(searchQuery);
  }
}
